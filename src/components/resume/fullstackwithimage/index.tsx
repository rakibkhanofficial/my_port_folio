...
const FullstackwithImage: React.FC = () => {
      ...
      <div className="flex min-h-screen flex-col items-center bg-gray-100 p-4">
        <div className="my-8 w-full max-w-4xl bg-white shadow-lg">
          ...
          <div ref={resumeRef} className="bg-white p-6 print:p-4">
            ...
            <div className="border-b-2 border-gray-300 pb-1.5 print:pb-1">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-700 print:mt-1 print:gap-x-2">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-4 text-xs text-gray-700 print:mt-0.5 print:gap-x-2">
                    <div className="flex items-center gap-1">
                ...
                <div className="flex-shrink-0">
                  <div className="h-28 w-28 overflow-hidden print:h-24 print:w-24">
                    <img
                      src="/myimage.jpg"
                      alt="Rakib Khan"
...
export default FullstackwithImage;
