...
// const WithoutImageResume: React.FC = () => {
...
//                 <strong>3+ years of specialized experience</strong> building
...
//                     </h4>
//                     <p className="mt-0.5 text-xs leading-tight text-gray-700">
//                       Jest, React Testing Library, Cypress, Unit Testing,
//                       Integration Testing
//                     </p>
//                   </div>
//                   <div>
...
//                     </li>
//                     <li>
//                       Integrated <strong>NextAuth authentication</strong> with
//                       multiple providers, ensuring secure user sessions and data
//                       protection
//                     </li>
//                   </ul>
//                 </div>
...
//                       multiple user roles and developed{" "}
...
//                       automated email notifications and comprehensive analytics
//                       for claim management
//                     </li>
//                     <li>
//                       Utilized <strong>Redis caching</strong>, improving API
//                       response time by <strong>40%</strong> and enhancing user
//                       experience
//                     </li>
//                   </ul>
//                 </div>
...
//                     <li>
//                       Engineered{" "}
//                       <strong>complete POS and inventory solution</strong> with
...
//                       created customizable reports providing actionable business
//                       insights
//                     </li>
//                   </ul>
//                 </div>
...
// export default WithoutImageResume;
