...
const FrontendDeveloperWithImageResume: React.FC = () => {
            ...
            <div className="border-b-2 border-gray-300 pb-1.5">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-700">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-4 text-xs text-gray-700">
                    <div className="flex items-center gap-1">
...
export default FrontendDeveloperWithImageResume;
